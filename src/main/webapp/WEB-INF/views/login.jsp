...
<link rel="stylesheet" type="text/css"
	href="${staticPath }/static/style/css/login.css?v=201612202107" />
<script type="text/javascript"
	src="${staticPath }/static/login.js?v=20170115" charset="utf-8"></script>
</head>
<body onkeydown="enterlogin();">
	...
	<div style="text-align: center;">
		<p>
			<a href="javascript:void(0);">界外视觉</a>
		</p>
	</div>
</body>
</html>
