...
<link rel="shortcuticon" href="${staticPath }/static/style/images/favicon.ico" />
<%-- [my97日期时间控件] --%>
...
<%-- [统计控件] --%>
<script type="text/javascript" src="${staticPath }/static/ueditor/third-party/highcharts/highcharts.js" charset="utf-8"></script>
<script type="text/javascript" src="${staticPath }/static/statistical/js/core.js" charset="utf-8"></script>
