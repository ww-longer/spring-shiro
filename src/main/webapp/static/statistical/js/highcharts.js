...
(function () {
    ...
    L = {
        ...
        tooltip: {
            ...
            pointFormat: '<span style="color:{series.color}">a��?</span> {series.name}: <b>{point.y}</b><br/>',
            shadow: !0,
            snap: Hb ? 25 : 10,
    ...
    ca.scatter = w(T, {
        lineWidth: 0,
        tooltip: {
            headerFormat: '<span style="color:{series.color}">a��?</span> <span style="font-size: 10px;"> {series.name}</span><br/>',
