 ...
 * @date 2016-12-01
 */
public class CopyOfMysqlGenerator {
	...
	public static void main(String[] args) {
		...
		String outputDir = "C:/Users/jiewai/Desktop/code";
	...
	private static Properties getProperties() {
		// 读取配置文件
		Resource resource = new ClassPathResource("/config/application_ssm.properties");
